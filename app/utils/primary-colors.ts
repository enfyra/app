...
export function getPrimaryColorStyle(primary: PrimaryColorValue) {
  ...
  const aliases = [
    ...
    "--gradient-primary:linear-gradient(135deg,var(--brand-500) 0%,var(--brand-600) 50%,var(--accent-cyan) 100%)",
    "--gradient-primary-reverse:linear-gradient(135deg,var(--accent-cyan) 0%,var(--brand-600) 50%,var(--brand-500) 100%)",
    "--gradient-violet-cyan:linear-gradient(135deg,var(--brand-500) 0%,var(--accent-cyan) 100%)",
