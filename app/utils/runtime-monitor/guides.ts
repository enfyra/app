    ...
    groups: [
      {
        ...
        items: [
          ...
          ['Queue wait p95 / p99', 'Time spent waiting for an executor lane before script execution starts. High values identify lane-admission saturation directly.'],
          ['Execution p95 / p99', 'Slow-tail script execution latency after a lane has been assigned. High execution latency points to user logic, host I/O, or package work.'],
