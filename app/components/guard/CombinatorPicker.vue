<template>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-3" role="listbox" aria-label="Combinator">
    <div
...
const options = [
  ...
  },
  {
    ...
    label: 'OR',
    icon: 'lucide:split',
    activeClass: 'eapp-status-info-soft',
    checkColor: 'eapp-status-info-text',
    iconBg: 'bg-[var(--status-info-base)]',
