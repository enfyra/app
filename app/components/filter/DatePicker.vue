        ...
        <template #content="{ close }">
          <div class="filter-date-picker-popover p-3 flex flex-col gap-3">
            <div class="flex items-center justify-between">
              ...
              <UButton icon="lucide:x" aria-label="Close date picker" color="neutral" variant="ghost" size="xs" class="min-h-[44px] min-w-[44px]" @click="close" />
            </div>
          ...
          <template #content="{ close }">
            <div class="filter-date-picker-popover p-3 flex flex-col gap-3">
              <div class="flex items-center justify-between">
                ...
                <UButton icon="lucide:x" aria-label="Close start date picker" color="neutral" variant="ghost" size="xs" class="min-h-[44px] min-w-[44px]" @click="close" />
              </div>
          ...
          <template #content="{ close }">
            <div class="filter-date-picker-popover p-3 flex flex-col gap-3">
              <div class="flex items-center justify-between">
                ...
                <UButton icon="lucide:x" aria-label="Close end date picker" color="neutral" variant="ghost" size="xs" class="min-h-[44px] min-w-[44px]" @click="close" />
              </div>
