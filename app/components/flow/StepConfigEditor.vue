  ...
  <div class="space-y-3 w-full">
    ...
    <template v-if="type === 'script'">
      ...
      <UFormField label="Code" class="w-full">
        <FormCodeEditorLazy :model-value="sourceCode" @update:model-value="update('sourceCode', $event)" :language="scriptLanguage" :enfyra-autocomplete="true" height="220px" class="w-full" />
      </UFormField>
    </template>
    ...
    <template v-else-if="type === 'condition'">
      ...
      <UFormField label="Condition Code" class="w-full">
        <FormCodeEditorLazy :model-value="sourceCode" @update:model-value="update('sourceCode', $event)" :language="scriptLanguage" :enfyra-autocomplete="true" height="120px" class="w-full" />
      </UFormField>
    </template>
