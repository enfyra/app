...
const {
  ...
  query: computed(() => ({
    fields: [
      ...
      "columns.fieldPermissions.role.name",
      "columns.fieldPermissions.allowedUsers.id",
      "columns.fieldPermissions.allowedUsers.email",
      "columns.fieldPermissions.allowedUsers.name",
      "relations.fieldPermissions.*",
      "relations.fieldPermissions.role.id",
      "relations.fieldPermissions.role.name",
