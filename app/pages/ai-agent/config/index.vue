      ...
      >
        ...
        >
          <div class="hidden md:flex items-start justify-between gap-4">
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 mb-2">
                <UIcon name="lucide:brain" class="w-5 h-5 text-primary flex-shrink-0" />
          ...
          <div class="md:hidden space-y-3">
            <div class="flex items-start gap-3">
              <UIcon name="lucide:brain" class="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
              <div class="flex-1 min-w-0">
                <h3 class="font-semibold text-white text-base mb-1.5">{{ config.provider || 'AI Provider' }}</h3>
